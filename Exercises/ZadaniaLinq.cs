...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie01_StudenciZWarszawy()
    {
        ...
        var myLinqQuery = from s in DaneUczelni.Studenci
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny()
    {
        ...
        return przedmiot != null 
            ...
            : ["Brak przedmiotu w kategorii Analytics"];
    }
    ...
    {
        bool istniejeNieaktywny = DaneUczelni.Zapisy
            .Any(z => !z.CzyAktywny);
    ...
    public IEnumerable<string> Zadanie06_CzyWszyscyProwadzacyMajaKatedre()
    {
        ...
        return [wszyscyMajaKatedre.ToString()];
    }
    ...
    public IEnumerable<string> Zadanie07_LiczbaAktywnychZapisow()
    {
        ...
        return [liczbaAktywnych.ToString()];
    }
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        return from z in DaneUczelni.Zapisy
            ...
            join p in DaneUczelni.Przedmioty on z.PrzedmiotId equals p.Id
            group z by p.Nazwa into g
            select $"{g.Key}: {g.Average(x => x.OcenaKoncowa.Value):F2}";
    }
    ...
    public IEnumerable<string> Zadanie15_ProwadzacyILiczbaPrzedmiotow()
    {
        return from pr in DaneUczelni.Prowadzacy
            // GroupJoin w LINQ pełni rolę LEFT JOIN
            join p in DaneUczelni.Przedmioty 
                on pr.Id equals p.ProwadzacyId into prPrzedmioty
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        return from s in DaneUczelni.Studenci
            ...
            select $"{g.Key.Imie} {g.Key.Nazwisko}: {g.Max(x => x.OcenaKoncowa.Value)}";
    }
